...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2026 at 08:58 PM
...
INSERT INTO `mesaje` (`Id_mesaj`, `sender_id`, `receiver_id`, `content`, `sent_time`, `seen_time`) VALUES
(1, 12, 1, 'ceva', '2026-01-12 21:24:37', NULL),
(2, 12, 1, 'ceva', '2026-01-12 21:34:51', NULL);
...
(12, 'pletosu@gmail.com', 'Vulpoiu', '$2y$10$30Qmt2VOj.Qx4RoFvc5I.OC7JswPmlIN3rE.1dVtmJxyzvyGXXhKO', '2026-01-10 22:44:09', '69654a88d398b_car2.png', '69654a8d2505a_pz1.png');
...
--
ALTER TABLE `mesaje`
  MODIFY `Id_mesaj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `users`
  MODIFY `IdUtilizator` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `user_inventory`
  ADD CONSTRAINT `user_inventory_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`IdUtilizator`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_inventory_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `shop` (`Item_id`) ON DELETE CASCADE;
COMMIT;
